...
public class FolderChildModel extends Model {
    ...
    public List<Item> getList(int type,int cat,int tab) {
        ...
        while (cursor.moveToNext()) {
            ...
            list.add(new Item().folder(id,name+" "+page+":"+position,text,type == 1?null:folderName,date,chapter,page,position,favorite == 1,underline == 1,color));
        }
        cursor.close();
        return list;
    }
