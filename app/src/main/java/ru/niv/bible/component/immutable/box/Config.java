...
import ru.niv.bible.component.mutable.config.AdConfig;
import ru.niv.bible.component.mutable.config.ColumnConfig;
import ru.niv.bible.component.mutable.config.LinkConfig;
import ru.niv.bible.component.mutable.config.LogConfig;
import ru.niv.bible.component.mutable.config.ParamConfig;
import ru.niv.bible.component.mutable.config.RecyclerViewConfig;
import ru.niv.bible.component.mutable.config.ScreenConfig;
import ru.niv.bible.component.mutable.config.TableConfig;
import ru.niv.bible.component.mutable.config.URLConfig;
import ru.niv.bible.component.mutable.config.ViewPagerConfig;
