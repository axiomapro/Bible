...
public class Static {
    ...
    public static final String log = "testLog";
    public static final String notificationChannel = "Bible channel";
    public static final String gmailPackage = "com.google.android.gm";
    // название экранов для определения вида списка
    public static final String sidebar = "Sidebar";
    public static final String bottomSheet = "Bottom sheet";
    public static final String main = "Main";
    public static final String favorites = "Favorites";
    public static final String favoritesFolder = "Favorites folder";
    public static final String favoritesBook = "Favorites book";
    ...
    public static final String tableChapter = "chapter";
    public static final String tableFolder = "folder";
    ...
    public static final String paramLineSpacing = "line-spacing";
    public static final String paramReadingSpeed = "reading-speed";
    public static final String paramSpeechPitch = "speech-pitch";
    public static final String paramFont = "font";
    public static final String paramLanguage = "language";
    public static final String paramSelection = "selection";
